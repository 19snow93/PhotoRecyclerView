...
public class BaseViewHolder extends RecyclerView.ViewHolder {
    ...
    public BaseViewHolder setGlideImage(@IdRes int viewId, String url) {
        ImageView view = getView(viewId);
        Glide.with(mContext)
                .load(url)
                .into(view);
    ...
    public BaseViewHolder setGlideAddPhotoImage(@IdRes int viewId, String url) {
        ImageView view = getView(viewId);
        Glide.with(mContext)
                .load(url)
                .error(mContext.getResources().getDrawable(R.drawable.add))
                .into(view);
        return this;
    }
